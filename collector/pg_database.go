...
func (PGDatabaseCollector) Name() string {
	return "Gauss databasse collector"
}

func (PGDatabaseCollector) Help() string {
	return "GaussDB database related information"
}

func (PGDatabaseCollector) Version() float64 {
	return 1.0
}

// Scrape implements Collector and exposes database size and connection limits.
...
func (PGDatabaseCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
