...
func (PGStatBGWriterCollector) Name() string {
	return "stat bg writer collector"
}

func (PGStatBGWriterCollector) Help() string {
	return "stat bg writer information"
}

func (PGStatBGWriterCollector) Version() float64 {
	return 1.0
}

func (PGStatBGWriterCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
