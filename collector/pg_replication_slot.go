...
func (PGReplicationSlotCollector) Name() string {
	return "replication slot collector"
}

func (PGReplicationSlotCollector) Help() string {
	return "replication slot information"
}

func (PGReplicationSlotCollector) Version() float64 {
	return 1.0
}

func (PGReplicationSlotCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
