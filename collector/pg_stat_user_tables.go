...
func (PGStatUserTablesCollector) Name() string {
	return "status user tables collector"
}

func (PGStatUserTablesCollector) Help() string {
	return "status user tables information"
}

func (PGStatUserTablesCollector) Version() float64 {
	return 1.0
}

func (PGStatUserTablesCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
