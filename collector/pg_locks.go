...
func (PGLocksCollector) Help() string {
	return "lock collector information"
}

func (PGLocksCollector) Version() float64 {
	return 1.0
}

// Scrape implements Collector and exposes database locks.
// It is called by the Prometheus registry when collecting metrics.
func (PGLocksCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
