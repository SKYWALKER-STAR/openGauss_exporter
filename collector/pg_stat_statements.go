...
func (PGStatStatementsCollector) Name() string {
	return "statement collector"
}

func (PGStatStatementsCollector) Help() string {
	return "statement information"
}

func (PGStatStatementsCollector) Version() float64 {
	return 1.0
}

func (PGStatStatementsCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
