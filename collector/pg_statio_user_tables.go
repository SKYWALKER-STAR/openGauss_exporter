...
func (PGStatIOUserTablesCollector) Name() string {
	return "statio user tables collector"
}

func (PGStatIOUserTablesCollector) Help() string {
	return "statio user tables information"
}

func (PGStatIOUserTablesCollector) Version() float64 {
	return 1.0
}

func (PGStatIOUserTablesCollector) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric,logger log.Logger) error {
